...
```yaml
url: http://HOST_IP:HOST_PORT/static/denon-vtuner-tile.js?v=0.1.3
type: module
```
...
use `/local/denon-vtuner-tile.js?v=0.1.3` as the resource URL.
...
2. Open the resource URL from the same browser/device that runs Home Assistant:
   ...
   ```text
   http://HOST_IP:HOST_PORT/static/denon-vtuner-tile.js?v=0.1.3
   ```
